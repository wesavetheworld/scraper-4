...
{   
	...
	public function updateKeywords()
	{
		...
		{	
			// Add keyword to insert array 
			$insert[] = array("_id" => $keyword->keyword_id, ENGINE => $keyword->rank, ENGINE."_match" => $keyword->found); 
		}  
				
		// Batch insert all new ranking data
		$this->db->serps->rankings->batchInsert($insert); 	
	} 

	...
	{   
		...
		{    		
			...
			$this->scrapesBad++;
		 	...
		 	// Log current state
			utilities::notate("\tcode: ".$this->results[$i]['httpInfo']['http_code']);					
			utilities::notate("\tsize: ".$this->results[$i]['httpInfo']['size_download']);
			utilities::notate("\tproxy source: ".$this->results[$i]['proxy_info']['source']);			 
		} 	
	}
